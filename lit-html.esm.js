...
// in a Map.
export var templateCaches = new Map();
/**
 ...
 */
export var TemplateResult = function () {
 ...
 */
export var SVGTemplateResult = function (_TemplateResult) {
 ...
 * to Part.update().
 */
export var TemplatePart = function TemplatePart(type, index, name, rawName, strings) {
 ...
 */
export var getValue = function getValue(part, value) {
...
export var AttributePart = function () {
...
export var defaultPartCallback = function defaultPartCallback(instance, templatePart, node) {
 ...
 * with new values.
 */
export var TemplateInstance = function () {
            ...
            if (parts.length > 0) {
                ...
                for (var i = 0; i < parts.length; i++) {
                    ...
                    if (node.nodeType === 8) {
                        ...
                        _walker.currentNode.parentNode.replaceChild(node, _walker.currentNode);
                        _walker.currentNode = node;
                    }
 ...
 */
export var removeNodes = function removeNodes(container, startNode) {
